 ...
 * @since 1.0.0
 */
class Photomania_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'photomania';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'photomania' ), $i ),
...
// Initialize.
$photomania_footer_widgets = new Photomania_Footer_Widgets();
